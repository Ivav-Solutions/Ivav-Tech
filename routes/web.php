...
Route::get('/service/it_trainings/project_management/scrum_program', [App\Http\Controllers\HomePageController::class, 'scrum_program']);
Route::get('/service/it_trainings/project_management/quality_management_program', [App\Http\Controllers\HomePageController::class, 'quality_management_program']);
...
Route::get('/service/it_trainings/project_management/prince2_program', [App\Http\Controllers\HomePageController::class, 'prince2_program']);
Route::get('/service/it_trainings/project_management/marketing_program', [App\Http\Controllers\HomePageController::class, 'marketing_program']);
Route::get('/service/it_trainings/project_management/itil', [App\Http\Controllers\HomePageController::class, 'itil']);
