                ...
                <div class="col-12">
                    <div class="card text-center overflow-hidden">
                        <div class="card-body">
                            ...
                            <a href="/service/it_programs/risk_management_program" class="btn btn-info">Read More</a>
                            <a href="payment/{{Crypt::encrypt(150)}}/{{Crypt::encrypt('Risk Management Program Course')}}" class="btn btn-info">Enroll</a>
                        </div>
                    </div>
                </div><!-- COL-END -->
            </div>
