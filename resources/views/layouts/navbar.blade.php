                    ...
                    <ul class="navbar-nav text-left">
                        ...
                        <li class="nav-item"><a class="nav-link dropdown-toggle {{ (request()->is('service*')) ? 'active' : '' }}" href="#">Services</a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link {{ (request()->is('service/software_development/mobile_development')) ? 'active' : '' }}" href="#">Mobile Development</a></li>
                                <li class="nav-item"><a class="nav-link {{ (request()->is('service/software_development/desktop_development')) ? 'active' : '' }}" href="#">Desktop Development</a></li>
