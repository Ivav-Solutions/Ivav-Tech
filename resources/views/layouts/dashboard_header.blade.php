                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        ...
                                        @else
                                        <div class="avatar profile-user brround cover-image" style="background:#1d42d9; color: #fff; display: flex; justify-content: center;">{{ ucfirst(substr(Auth::user()->last_name, 0, 1)) }}</div>
                                        @endif
                                    </span>
