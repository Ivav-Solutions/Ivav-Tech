        ...
        <tr>
            <td  align="center">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" valign="top" style="padding: 10px 30px 10px 30px; font-size: 20px; background: #010e1f; text-align: center;"> 
                            <img src="{{URL::asset('images/logo.png')}}" alt="{{config('app.name')}}" style="width: 100px"></a>
						</td>
                    </tr>
                </table>
            </td>
