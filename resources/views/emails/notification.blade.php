    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="center" valign="top" style="padding: 40px 30px 20px 30px; font-size: 20px;"> 
                            <img src="{{URL::asset('images/logo.png')}}" alt="{{config('app.name')}}" width="100px"></a>
						</td>
                    </tr>
                </table>
            </td>
		...
		<tr>
            <td align="center" style="padding: 0px 10px 0px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left" valign="top" style="border-bottom: 1px solid #010e1f; border-top: 1px solid #010e1f; padding: 10px 30px 20px 30px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 1px; line-height: 10px;">
